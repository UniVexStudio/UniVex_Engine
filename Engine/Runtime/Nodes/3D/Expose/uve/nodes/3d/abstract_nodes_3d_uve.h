...
// The abstract kinds between Node3D and the concrete 3D nodes. None of them is ever created on its
// own - none appears in the Add-Node library - they exist so their children share one definition
...
/// The PhysicsObject3D recipe, then the base's own component.
void ApplySolidBody3DBaseUVE(IEntityManagerUVE& entityManager, EntityUVE entity, std::string_view nameFallback);
