#include "WorldUveEntitySource.h"

#include "uve/scene/components/world_transform_component_uve.h"

namespace univex::integration {

std::vector<EntityTransformUVE> WorldUveEntitySource::GetEntityTransformsUVE() const {
    std::vector<EntityTransformUVE> transforms;
    world_.GetEntityManagerUVE().ForEachUVE<UVE::Scene::WorldTransformComponentUVE>(
