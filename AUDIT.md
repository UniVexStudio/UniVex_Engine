...
Remaining open items: §5.2–§5.6, §6.2–§6.3 (full math merge deferred by design), §7 naming, and §10 (full link/test verification on a GL-capable machine — now automated by CI).
